---
title: "Paginate and Filter Zolt API List Responses"
...
GET https://api.zolt.io/v1/projects?limit=20
```

```bash title="Subsequent page using a cursor"
GET https://api.zolt.io/v1/projects?limit=20&cursor=eyJpZCI6MTIzfQ
```
...
GET https://api.zolt.io/v1/tasks?filter[status]=in_progress&filter[assignee_id]=user_abc
```

```bash title="Filter high-priority tasks in a project"
GET https://api.zolt.io/v1/projects/proj_abc123/tasks?filter[priority]=high&filter[status]=todo
```
...
GET https://api.zolt.io/v1/projects/proj_abc123/tasks?sort=due_date
```

```bash title="Projects sorted by most recently updated"
GET https://api.zolt.io/v1/projects?sort=-updated_at
```
